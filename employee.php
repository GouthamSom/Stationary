...
$sql=" INSERT INTO `employee`(`first name`, `last name`, `middle name`, `email`, `DOJ`, `DOR`, `DOB`, `userid`, `password`, `designation`)
 VALUES ('$fname','$lname','$mname','$email','$DOJ','$DOR','$DOB','$uid','$pwd','$des')";
    ...
    <?php include('sidebar.php');?>
            ...
            <div class="card" style="margin-top: auto; padding-left:auto; margin:120px;"> 
               ...
               <div class="card-body" style="margin-top: auto; float:left;" >                        
                ...
                <button type="submit" name="submit" style="  margin:20px;" >submit</button>
